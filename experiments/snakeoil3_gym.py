            ...
            try:
                ...
                if n_fail < 0:
                    ...
                    if self.vision is False:
                        ...
                        os.system(u'torcs -r ~/.torcs/config/raceman/quickrace.xml -nofuel -nolaptime &')
                        # os.system(u'torcs -r ~/.torcs/config/raceman/practice.xml -nofuel -nodamage -nolaptime &')
                    else:
                        #os.system(u'torcs -nofuel -nolaptime -vision &')
                        # os.system(u'torcs -r ~/.torcs/config/raceman/practice.xml -nofuel -nodamage -nolaptime -vision &')
